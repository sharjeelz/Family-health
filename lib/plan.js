...
export const FAMILY = [
  { id: "dad", name: "Dad", color: "clay", photo: "/dad.jpg", pos: "50% 25%" },
  { id: "mom", name: "Mom", color: "sage", photo: "/mom.jpg", pos: "50% 27%" },
  { id: "son", name: "Zohaib", color: "clay", photo: "/zohaib.jpg", pos: "50% 12%" },
  { id: "daughter", name: "Zainab", color: "sage", photo: "/zainab.jpg", pos: "50% 20%" },
];
...
export const HABITS = [
  { id: "veg", label: "Half-plate veg at lunch & dinner" },
  { id: "water", label: "Water was the main drink" },
  { id: "nosugar", label: "No sugary drinks today" },
  { id: "move", label: "Everyone moved / played 30–60 min" },
  { id: "together", label: "Ate a meal together, no screens" },
];
...
// Al Ijadah International School, from the timetables in public/Grade_3.pdf and
// public/KG3.pdf. Seven periods a day, Sunday to Thursday.
//
// Subjects that appear twice in a day are listed once: the point of this is
// packing a bag the night before, and nobody packs two English books.
//
// The ids are historical — "iiif" was III-F at the previous school. Kept
// because the chores star chart stores its data against them.
export const STUDY = {
  // Sunday
  0: {
    iiif: ["English", "Art", "Science", "Arabic", "ICT & Robotics", "Math"],
    nursery: ["CCA", "English", "Arabic", "Islamic", "Math"],
  },
  // Monday
  1: {
    iiif: ["CCA", "Arabic / SP Arabic", "Math", "Islamic", "English"],
    nursery: ["ICT & Robotics", "English", "Art", "Arabic / SP Arabic", "Second Language", "Math"],
  },
  // Tuesday
  2: {
    iiif: ["PE", "Science", "Second Language", "Math", "Islamic", "English"],
    nursery: ["PE", "Arabic", "English", "Second Language", "Islamic", "Math"],
  },
  // Wednesday
  3: {
    iiif: ["English", "Second Language", "Science", "Arabic / SP Arabic", "Math", "PE", "Social Studies"],
    nursery: ["Music", "English", "Islamic", "ICT & Robotics", "Math", "Arabic"],
  },
  // Thursday
  4: {
    iiif: ["Arabic", "Science", "Islamic", "ICT & Robotics", "Math", "Music", "English"],
    nursery: ["English", "Art", "Math", "Arabic / SP Arabic", "Science", "PE"],
  },
...
export const CHILDREN = [
  { id: "iiif", name: "Zohaib", photo: "/zohaib.jpg", pos: "50% 12%", school: "Grade 3 · Al Ijadah Int'l School" },
  { id: "nursery", name: "Zainab", photo: "/zainab.jpg", pos: "50% 20%", school: "KG3 · Al Ijadah Int'l School" },
];
...
export const CHORES = [
  ...
  { id: "tidy", label: "Tidy toys & books" },
  { id: "homework", label: "Homework / reading" },
  { id: "table", label: "Help set the table" },
  { id: "prayer", label: "Prayer / Qur'an" },
];
