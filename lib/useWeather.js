    ...
    async function fetchWeather(lat, lon, city) {
      try {
        ...
        const fresh = {
          ...
          city: city || null,
          high: d ? Math.round(d.temperature_2m_max[0]) : null,
          low: d ? Math.round(d.temperature_2m_min[0]) : null,
          // "2026-08-21T05:31" — local time already, so just take the clock part.
          sunrise: d ? d.sunrise[0].slice(11, 16) : null,
          sunset: d ? d.sunset[0].slice(11, 16) : null,
        };
