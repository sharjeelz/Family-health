...
export const SCHOOL_EVENTS = [
  ...
  // --- MAP tests ------------------------------------------------------------
  // These appear nowhere in the written tables — only as light blue blocks on
  // the month grids. Dates read from the printed calendar's colouring, so
  // confirm them against the school before relying on them.
  { date: "2026-09-14", end: "2026-09-17", title: "MAP Test" },
  { date: "2027-01-24", end: "2027-01-27", title: "MAP Test" },
  { date: "2027-03-21", end: "2027-03-25", title: "MAP Test" },
